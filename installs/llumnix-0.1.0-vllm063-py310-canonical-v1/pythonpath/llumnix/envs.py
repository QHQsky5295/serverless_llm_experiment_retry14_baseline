...
from llumnix.constants import (
    ...
    WAIT_PLACEMENT_GROUP_TIMEOUT as DEFAULT_WAIT_PLACEMENT_GROUP_TIMEOUT,
)
...
environment_variables: Dict[str, Callable[[], Any]] = {
    ...
    lambda: os.getenv(
        "LLUMNIX_WAIT_PLACEMENT_GROUP_TIMEOUT",
        str(DEFAULT_WAIT_PLACEMENT_GROUP_TIMEOUT),
    ),
    ...
    lambda: os.getenv(
        "LLUMNIX_INSTANCE_READY_TIMEOUT",
        str(DEFAULT_INSTANCE_READY_TIMEOUT),
    ),
    "UNIT_READY_TIMEOUT":
    ...
    lambda: os.getenv(
        "LLUMNIX_UTILITY_CALL_TIMEOUT",
        str(DEFAULT_UTILITY_CALL_TIMEOUT),
    ),
}
