...
from llumnix.utils import get_ip_address, log_instance_exception, ray_get_with_timeout, LaunchMode
...
def init_llumnix_components(entrypoints_args: EntrypointsArgs,
    ...
    instance_ids, instances = ray.get(
        ...
        timeout=float(os.getenv("LLUMNIX_INIT_INSTANCES_TIMEOUT", "10.0")),
    )
