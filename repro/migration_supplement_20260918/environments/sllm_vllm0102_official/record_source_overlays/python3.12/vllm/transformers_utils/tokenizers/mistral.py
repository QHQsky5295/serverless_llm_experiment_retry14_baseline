...
class MistralTokenizer(TokenizerBase):
    ...
    def __init__(self, tokenizer: "PublicMistralTokenizer") -> None:
        ...
        # mistral_common>=1.9 deprecates passing None here and already treats
        # it as IGNORE for sentencepiece tokenizers. Make the intended runtime
        # behavior explicit so serving logs stay clean without changing decode
        # semantics for current experiments.
