...
if [ "${CONDA_BUILD:-0}" = "1" ]; then
  ...
  LDFLAGS_USED="-Wl,-O2 -Wl,--sort-common -Wl,--as-needed -Wl,-z,relro -Wl,-z,now -Wl,--disable-new-dtags -Wl,--gc-sections -Wl,-rpath,${PREFIX}/lib -Wl,-rpath-link,${PREFIX}/lib -L${PREFIX}/lib"
...
_CONDA_PYTHON_SYSCONFIGDATA_NAME_USED=${_CONDA_PYTHON_SYSCONFIGDATA_NAME:-_sysconfigdata_x86_64_conda_linux_gnu}
...
_tc_activation \
  ...
  "CC,${CONDA_PREFIX}/bin/x86_64-conda-linux-gnu-cc" cpp gcc gcc-ar gcc-nm gcc-ranlib \
