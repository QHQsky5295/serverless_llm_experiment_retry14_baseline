...
- **configs/experiments.yaml** 当前默认入口已经切到 `qwen_14b_tp2_v2_publicmix + azure_sharegpt_rep1000 + qwen_14b_tp2_a500_main`；当前主线口径为 `Qwen 7B / Mistral 7B -> TP=1 + max_instances=2`、`Qwen 14B / Mistral-Nemo -> TP=2 + max_instances=1`。
