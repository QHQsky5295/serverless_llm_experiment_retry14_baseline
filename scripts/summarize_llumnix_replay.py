#!/usr/bin/env python3
"""Summarize a Llumnix replay with the RelayServe paper metric contract."""
...
def main() -> int:
    ...
    parser.add_argument("--system-name", default="Llumnix")
    ...
    scenario = {
        "scenario_name": "llumnix_relayserve_continuation",
    ...
    payload = {
        ...
        "system": args.system_name,
        "system_key": "llumnix",
        "runtime_class": "static_serverful",
        "model": args.model,
        "model_key": args.model_key,
