...
- current gate: Llama-3.2 3B passes a 64-adapter / 256-request filtered gate;
  Llama-2 7B passes a 16-adapter / 64-request filtered gate on the closed
  true-remote trace and real PEFT adapters.
